Feature: Sign Up
  ...
  Scenario: Sign Up just with name
      ...
      Then  I click on "button signup"
      And   I see "All fields are required."
  ...
  Scenario: Sign Up with empty name
      ...
      Then  I click on "button signup"
      And   I see "Apologies, "Name" allows only alphanumeric characters, hyphen, dash, underscores and spaces."
  ...
  Scenario: Sign Up with invalid email
      ...
      Then  I click on "button signup"
      And   I see "Please enter a valid email address."
  ...
  Scenario: Sign Up with invalid short password
      ...
      Then  I click on "button signup"
      And   I see "Password must have from 6 to 20 characters"
  ...
  Scenario: Sign Up with empty password
      ...
      Then  I click on "button signup"
      And   I see "Sorry, password can't be blank."
  ...
  Scenario: Sign Up with different passwords
      ...
      Then  I click on "button signup"
      And   I see "Oops! Your passwords don’t match, try again."
